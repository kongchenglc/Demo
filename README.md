...
&emsp;&emsp;仿`github404`页面**动画**特效，原生`js`实现。[博客详解](https://kongchenglc.github.io/blog/github40420170720/)。    
...
&emsp;&emsp;原生`js`实现简单**轮播图**的组件化，可在同一页面多次使用。[博客详解](https://kongchenglc.github.io/blog/%E8%BD%AE%E6%92%AD%E5%9B%BE20170801/)  

- [3Dbox.html](https://github.com/kongchenglc/Demo/blob/master/3Dbox.html)

&emsp;&emsp;`css3 + js`实现**3D盒子**，可用滚轮及拖拽调整视角。[博客详解](https://kongchenglc.github.io/blog/3Dbox20170827/)    
...
&emsp;&emsp;`20`行代码的**贪吃蛇**，`canvas`实现，[博客详解](https://kongchenglc.github.io/blog/%E8%B4%AA%E5%90%83%E8%9B%8720170613/)。
